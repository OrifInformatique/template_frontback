...
public class AuthController {
     ...
     */
    @GetMapping("/after-oauth2-login")
    public void afterOauth2Login() {
        log.debug("OAuth2 login successful, processing post-login actions");
        
        // Extract user info from request body
        
        // Perform any necessary post-login processing (e.g., registering the user, creating a session, setting cookies, etc.)
