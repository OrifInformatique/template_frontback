...
public class AuthClient {
        ...
        /**
         * Soft or hard deletes a user globaly, by sending a delete request to the authentication
         * provider.
         * 
         * @param token  The access token
         * @param userLogin The username (login) of the user to delete
         ...
         */
        public Mono<ResponseEntity<Map<String, String>>> deleteGlobalUser(String token, String userLogin, boolean hardDelete) {
                return webClient.delete()
                                .uri("/users/" + userLogin + "/" + hardDelete) // soft or hard delete user endpoint path in authentication provider
                                .header(HttpHeaders.AUTHORIZATION, token)
                                .retrieve()
